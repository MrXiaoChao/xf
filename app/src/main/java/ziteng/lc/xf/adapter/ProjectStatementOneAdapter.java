...
public class ProjectStatementOneAdapter extends BaseAdapter {

    private Context context;
    private List<ProjectStatement.SubclassificationBeanX> list;

    public ProjectStatementOneAdapter(Context context,List<ProjectStatement.SubclassificationBeanX> list) {
