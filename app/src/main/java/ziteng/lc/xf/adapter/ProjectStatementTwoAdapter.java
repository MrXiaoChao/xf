...
public class ProjectStatementTwoAdapter extends BaseAdapter {

    private Context context;
    private List<ProjectStatement.SubclassificationBeanX.SubclassificationBean> list;

    public ProjectStatementTwoAdapter(Context context, List<ProjectStatement.SubclassificationBeanX.SubclassificationBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_projectstatment, null);
