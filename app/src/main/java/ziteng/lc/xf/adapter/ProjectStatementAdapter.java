...
public class ProjectStatementAdapter extends BaseAdapter {

    private Context context;
    private List<ProjectStatement> list;

    public ProjectStatementAdapter(Context context, List<ProjectStatement> list) {
